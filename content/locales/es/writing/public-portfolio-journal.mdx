...
investing:
  ...
  direction: "neutral"
  horizon: "Largo plazo"
  disclosure: "Sin posicion actual"
  summary: "Una nota publica de proceso inversor para que las decisiones sobre acciones sean mas faciles de inspeccionar despues."
  thesis: "Escribir decisiones sobre acciones en publico crea memoria falsable y hace mas dificil excusar un razonamiento flojo."
  invalidation: "El diario se convierte en comentario sin decisiones, o los registros no mejoran la calidad de la revision."
  catalysts:
    - "Primera tesis sobre un ticker especifico"
    - "Primer postmortem de una posicion cerrada o una tesis rota"
    - "Una cadencia de revision repetible"
  decisionTriggers:
    - "Anadir cuando la tesis, el riesgo y la prueba de invalidacion esten claros."
    - "Reducir cuando el tamano de posicion supere la conviccion o nueva evidencia debilite el setup."
    - "Salir cuando se rompe la tesis original."
    - "Evitar cuando el unico argumento es price action o prueba social."
  risk: "El diario podria derivar hacia hot takes en vez de registros de decision."
