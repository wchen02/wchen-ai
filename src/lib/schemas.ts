...
export const UiContentSchema = z.object({
  ...
  listen: z.object({
    label: z.string().min(1),
    hideLabel: z.string().min(1).optional(),
    ariaLabel: z.string().min(1),
    transcriptAriaLabel: z.string().min(1).optional(),
    readAlongHint: z.string().min(1).optional(),
    loading: z.string().min(1).optional(),
    error: z.string().min(1).optional(),
    retry: z.string().min(1).optional(),
    playLabel: z.string().min(1).optional(),
    pauseLabel: z.string().min(1).optional(),
    progressAriaLabel: z.string().min(1).optional(),
    speedMenuAriaLabel: z.string().min(1).optional(),
    closeStickyLabel: z.string().min(1).optional(),
    scrollFollowLabel: z.string().min(1).optional(),
    scrollFollowShortLabel: z.string().min(1).optional(),
    scrollFollowHint: z.string().min(1).optional(),
    scrollFollowOn: z.string().min(1).optional(),
    scrollFollowOff: z.string().min(1).optional(),
  }),
  ...
  writing: z.object({
    ...
    loadMoreLabel: z.string().min(1),
    loadMoreAriaLabel: z.string().min(1),
    showingCountTemplate: z.string().min(1),
    filterByThemeLabel: z.string().min(1),
    allThemesLabel: z.string().min(1),
    skipToThemeNavLabel: z.string().min(1),
...
export const WritingSchema = z.object({
  ...
  investing: z.object({
    ...
    showDecisionRecord: z.boolean().default(false),
    status: z.enum(["watching", "open", "closed", "review"]).optional(),
